    ...
    <div className="card-body">
      ...
      <div className="input-group mb-3">
        ...
        <div className="input-group mb-3">
            ...
            <br/>
            <button type="button" class="btn btn-secondary espacio" onClick={handleSumar}>Sumar</button>
            <button type="button" class="btn btn-secondary espacio" onClick={handleRestar}>Restar</button>
            <button type="button" class="btn btn-secondary espacio" onClick={handleMultiplicar}>Multiplicar</button>
            <button type="button" class="btn btn-secondary espacio" onClick={handleDividir}>Dividir</button>
            <button type="button" class="btn btn-primary espacio" onClick={handleLimpiar}>Limpiar</button>
            <br/>            
            <br/>
            <br/>
